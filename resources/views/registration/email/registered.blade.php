...
<head>
    ...
    <title>Email Konfirmasi Pendataan Mahasiswa Baru Universitas Prof. Dr. Moestopo (Beragama)</title>
    <style type="text/css">
        /* RESET STYLES */
        html {
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <div
                                                                                ...
                                                                                Konfirmasi Penerimaan Mahasiswa Baru
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                ...
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">
                                                                    Universitas Prof. Dr. Moestopo (Beragama)</h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                                Tutorial Anjungan Peserta Ujian</h3>
                                                                            <div
                                                                                style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                Untuk untuk informasi lengkap Anda bisa
                                                                                membaca pada URL <a
                                                                                    href="http://pmb.moestopo.ac.id/tutorial-registrasi"
                                                                                    target="_blank"
                                                                                    style="text-decoration:none;color:#db3445;">Tutorial </a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td align="right" valign="top" class="flexibleContainerBox"
                                                                ...
                                                                <table class="flexibleContainerBoxNext" border="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                                                                Anjungan Peserta Ujian</h3>
                                                                            <div
                                                                                style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                Silakan login ke Anjungan Peserta Ujian
                                                                                untuk memilih tanggal ujian <a
                                                                                    href="http://cama.moestopo.ac.id/"
                                                                                    target="_blank"
                                                                                    style="text-decoration:none;color:#db3445;">Anjungan
                                                                                                                                Peserta
                                                                                                                                Ujian</a>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div
                                                                                ...
                                                                                <i>
                                                                                    <b>Universitas Prof. Dr. Moestopo
                                                                                       (Beragama)</b><br/>
                                                                                    Kampus I : Jl.Hanglekir I No.8
                                                                                    Jakarta Pusat 10270, Telp :
                                                                                    (021)-7395333, 7396585, 7252686<br/>
                                                                                    Kampus II : Jl.Bintaro Permai Raya
                                                                                    No.3 Jakarta Selatan, Telp
                                                                                    (021)-73885254 <br/>
                                                                                    PMB UPDM(B), pmb@moestopo.ac.id,
                                                                                    Telp/Fax (021)-7220269, 7252225
                                                                                </i></div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>Copyright &#169; 2015 <a
                                                                            href="http://pmb.moestopo.ac.id"
                                                                            target="_blank"
                                                                            style="text-decoration:none;color:#828282;"><span
                                                                                style="color:#828282;">Penerimaan Mahasiswa Baru UPDM(B)</span></a>.
                                                                         All&nbsp;rights&nbsp;reserved.
                                                                    </div>
                                                                </div>
